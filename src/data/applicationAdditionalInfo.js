...
선수 번호표는 앞(왼쪽) / 뒤(오른쪽) 총 두 군데 착용합니다.
...
선수 번호표는 앞(왼쪽) / 뒤(오른쪽) 총 두 군데 착용합니다.`,
      ...
      "register/common_3.png": {
        ...
        sections: [
          {
            title: "종목 소개",
            body: "데님 피지컬을 보여주는 남성, 여성의 새로운 종목으로 단일 라운드로 진행됩니다.",
          },
          {
            title: "데님 출전자격",
            body: "대한민국 국민 + 국내에 거주하는 외국인",
          },
          {
            title: "데님 심사규정",
            body: `1. 데님 피지컬 (참조: 패션모델 피지컬과 동일 개념)
2. 워킹 밸런스
3. 포징 밸런스
4. 데님 표현력`,
          },
          {
            title: "데님 무대진행순서",
            body: `개인선수입장 > 무대중앙 자유포즈 > 개인선수퇴장 > 단체라인업재입장 > 규정포즈심사 > 퇴장

- 무대 중앙 워킹 & 자유포징 시간 30초 이내`,
          },
          {
            title: "데님 규정포즈",
            body: `1. 프론트 스탠스 핸드 포징
2. 사이드 스탠스 핸드 포징
3. 리어 스탠스 핸드 포징`,
          },
          {
            title: "데님 복장규정",
            body: `남자
상의: 데님 재킷, 소매 없는 데님 재킷
하의: 앞뒤 포켓이 있는 일자 데님 팬츠
...
남자: 맨몸에 데님 재킷 착용
여자: 데님 비키니 브라 착용 후 데님 재킷 착용

남녀 모두 맨발 착용 (신발 착용 금지)
...
선수 번호표는 앞(왼쪽) / 뒤(오른쪽) 총 두 군데 착용합니다.`,
      ...
      "register/common_4.png": {
        ...
        sections: [
          {
            title: "종목 소개",
            body: `단기간의 체중 감량 대회가 아니라, 건강한 라이프스타일 변화와 신체 개선 과정을 평가하는 종목으로 단일 라운드로 진행됩니다.

단순히 몸이 좋은 선수보다 얼마나 긍정적으로 변화했는지를 중요하게 평가하는 종목입니다.`,
          },
          {
            title: "출전자격",
            body: "대한민국 국민 누구나 + 국내에 거주하는 외국인",
          },
          {
            title: "심사규정",
            body: `1. 신체 변화도: 체지방 감소와 변화의 크기 (Before → After)
2. 현재 컨디션: 밸런스, 비율, 건강미, 탄력
3. 무대 표현력: 워킹, 포징, 자신감
4. 이미지 및 스타일: 헤어 & 메이크업, 복장 청결, 전체 인상
5. 스토리 및 자기관리: 변화 과정, 노력, 지속 가능성`,
          },
          {
            title: "무대진행순서",
            body: `개인선수입장 > 무대중앙 자유포즈 > 개인선수퇴장
