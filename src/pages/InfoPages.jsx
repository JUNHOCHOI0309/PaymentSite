    ...
    >
      <article className="site-committee-greeting">
        ...
        <div className="site-committee-greeting__body">
          <aside className="site-committee-greeting__profile">
            <img
            ...
            />
            <ul className="site-committee-greeting__profile-history" aria-label="조직위원장 주요 이력">
              {profileHistory.map((item) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </aside>
          <div className="site-committee-greeting__copy">
