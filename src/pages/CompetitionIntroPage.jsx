...
const localizedIntroContent = {
  ko: {
    ...
    competitionCopy: [
      "머슬마니아®와 피트니스 유니버스™ 프로페셔널 디비전은 자격을 갖춘 자연인 남녀 선수들을 위한 독점 이벤트입니다. 프로들은 오직 대회 성과, 공로 및 성격에 따라 자격을 갖춘 최고의 자연인 선수들로 구성된 존경받는 그룹입니다.",
...
export function CompetitionIntroPage() {
  ...
  return (
    <IntroPageLayout
      ...
      bodyTitle={t("header.competitionGuide")}
    >
